use std::{ffi::{c_void, CString, NulError, OsStr}, os::unix::ffi::OsStrExt, path::{Path, PathBuf}, process::Command};
...
pub fn format_ext2(devpath: &Path, label: Option<&String>) -> Result<(), UtilitiesError> {
